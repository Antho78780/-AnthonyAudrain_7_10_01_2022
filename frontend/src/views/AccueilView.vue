				...
				<div class="timeline-body">
					...
					<div class="timeline-likes">
						<div class="stats-right">
							<span class="stats-text">{{post.numberComments}} {{texteCommentaire}}</span>
						</div>
					</div>
					<div class="timeline-footer">
						<button type="button" @click="toutLesComments(post)" class="m-r-15 text-inverse-lighter"><i class="fa fa-comments fa-fw fa-lg m-r-3"></i>{{texteToutLesCommentaires}}</button> 
